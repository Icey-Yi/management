...
@connect(({ approvalDeposit, loading }) => ({ approvalDeposit, loading: loading.effects['approvalDeposit/getData'] }))
class Deposit extends Component {
  ...
  render() {
    ...
    const { approvalDeposit,loading } = this.props;
    const {data} = approvalDeposit;
    const columns = [
      {
        title: '审批编号',
        dataIndex: 'id',
